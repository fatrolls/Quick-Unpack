...
//=============================================================================
{
	...
	if(m_IPicture!=0) // Do Not Try To Read From Memory That Is Not Exist...
	{
...
//=============================================================================
{
	...
	{
		TCHAR szCause[0x100];
		e.GetErrorMessage(szCause,255,0);
		HWND hWnd=AfxGetApp()->GetMainWnd()->m_hWnd;
...
//=============================================================================
{
	...
	CreateILockBytesOnHGlobal(0,TRUE,&Buffer); // Create ILockBytes Buffer

	StgCreateDocfileOnILockBytes(Buffer,STGM_SHARE_EXCLUSIVE | STGM_CREATE | STGM_READWRITE,0,&pStorage);

	pStorage->CreateStream(L"PICTURE",STGM_SHARE_EXCLUSIVE | STGM_CREATE | STGM_READWRITE,0,0,&FileStream);
